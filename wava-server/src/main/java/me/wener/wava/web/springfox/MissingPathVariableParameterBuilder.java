...
class MissingPathVariableParameterBuilder implements OperationBuilderPlugin {
  ...
  public void apply(OperationContext operationContext) {
    ...
    while (matcher.find()) {
      ...
      if (!found) {
        // Parameter(String name, String description, String defaultValue, boolean required, boolean allowMultiple, Boolean allowEmptyValue, ModelReference modelRef, Optional<ResolvedType> type, AllowableValues allowableValues, String paramType, String paramAccess, boolean hidden, String pattern, String collectionFormat, int order, Object scalarExample, Multimap<String, Example> examples, List<VendorExtension> vendorExtensions) {
        // UNMATCH
//        Parameter parameter =
//            new Parameter(
//                var,
